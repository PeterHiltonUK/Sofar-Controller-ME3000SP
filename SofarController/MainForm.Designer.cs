namespace Controller
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            V8GaugeLabel v8GaugeLabel3 = new V8GaugeLabel();
            V8GaugeLabel v8GaugeLabel4 = new V8GaugeLabel();
            V8GaugeLabel v8GaugeLabel5 = new V8GaugeLabel();
            V8GaugeRange v8GaugeRange1 = new V8GaugeRange();
            V8GaugeLabel v8GaugeLabel6 = new V8GaugeLabel();
            V8GaugeRange v8GaugeRange2 = new V8GaugeRange();
            V8GaugeLabel v8GaugeLabel7 = new V8GaugeLabel();
            V8GaugeLabel v8GaugeLabel8 = new V8GaugeLabel();
            V8GaugeLabel v8GaugeLabel9 = new V8GaugeLabel();
            V8GaugeLabel v8GaugeLabel10 = new V8GaugeLabel();
            V8GaugeRange v8GaugeRange3 = new V8GaugeRange();
            V8GaugeLabel v8GaugeLabel11 = new V8GaugeLabel();
            V8GaugeLabel v8GaugeLabel12 = new V8GaugeLabel();
            V8GaugeRange v8GaugeRange4 = new V8GaugeRange();
            V8GaugeLabel v8GaugeLabel13 = new V8GaugeLabel();
            V8GaugeLabel v8GaugeLabel14 = new V8GaugeLabel();
            V8GaugeLabel v8GaugeLabel15 = new V8GaugeLabel();
            V8GaugeLabel v8GaugeLabel16 = new V8GaugeLabel();
            V8GaugeLabel v8GaugeLabel17 = new V8GaugeLabel();
            V8GaugeLabel v8GaugeLabel18 = new V8GaugeLabel();
            V8GaugeRange v8GaugeRange5 = new V8GaugeRange();
            V8GaugeRange v8GaugeRange6 = new V8GaugeRange();
            V8GaugeLabel v8GaugeLabel19 = new V8GaugeLabel();
            V8GaugeLabel v8GaugeLabel20 = new V8GaugeLabel();
            V8GaugeRange v8GaugeRange7 = new V8GaugeRange();
            ...
            v8GaugeLabel1.Position = new Point(70, 50);
            v8GaugeLabel1.Text = "Today Sold";
            v8GaugeLabel2.Color = Color.White;
            v8GaugeLabel2.Name = "GaugeLabel2";
            v8GaugeLabel2.Position = new Point(90, 65);
            v8GaugeLabel2.Text = "kWh";
            v8GaugeSold.GaugeLabels.Add(v8GaugeLabel1);
            v8GaugeSold.GaugeLabels.Add(v8GaugeLabel2);
            ...
            v8GaugeLabel3.Color = SystemColors.Info;
            v8GaugeLabel3.Name = "GaugeLabel1";
            v8GaugeLabel3.Position = new Point(70, 50);
            v8GaugeLabel3.Text = "Grid IO, kW";
            v8GaugeLabel4.Color = SystemColors.WindowText;
            v8GaugeLabel4.Name = "GaugeLabel2";
            v8GaugeLabel4.Position = new Point(0, 0);
            v8GaugeLabel4.Text = "90, 130";
            v8GaugeLabel5.Color = Color.Lime;
            v8GaugeLabel5.Name = "GaugeLabel1";
            v8GaugeLabel5.Position = new Point(90, 130);
            v8GaugeLabel5.Text = "";
            v8GaugeGridIO.GaugeLabels.Add(v8GaugeLabel3);
            v8GaugeGridIO.GaugeLabels.Add(v8GaugeLabel4);
            v8GaugeGridIO.GaugeLabels.Add(v8GaugeLabel5);
            v8GaugeRange1.Color = Color.Red;
            v8GaugeRange1.EndValue = 90F;
            v8GaugeRange1.InnerRadius = 1;
            v8GaugeRange1.InRange = false;
            v8GaugeRange1.Name = "GaugeRange1";
            v8GaugeRange1.OuterRadius = 2;
            v8GaugeRange1.StartValue = 0F;
            v8GaugeGridIO.GaugeRanges.Add(v8GaugeRange1);
            ...
            v8GaugeLabel6.Color = SystemColors.Info;
            v8GaugeLabel6.Name = "GaugeLabel1";
            v8GaugeLabel6.Position = new Point(67, 50);
            v8GaugeLabel6.Text = "Inverter Deg C";
            v8GaugeInverterT.GaugeLabels.Add(v8GaugeLabel6);
            v8GaugeRange2.Color = Color.Red;
            v8GaugeRange2.EndValue = 100F;
            v8GaugeRange2.InnerRadius = 70;
            v8GaugeRange2.InRange = true;
            v8GaugeRange2.Name = "GaugeRange1";
            v8GaugeRange2.OuterRadius = 80;
            v8GaugeRange2.StartValue = 45F;
            v8GaugeInverterT.GaugeRanges.Add(v8GaugeRange2);
            ...
            v8GaugeLabel7.Color = SystemColors.Info;
            v8GaugeLabel7.Name = "GaugeLabel1";
            v8GaugeLabel7.Position = new Point(69, 50);
            v8GaugeLabel7.Text = "Grid Bought";
            v8GaugeLabel8.Color = Color.White;
            v8GaugeLabel8.Name = "GaugeLabel2";
            v8GaugeLabel8.Position = new Point(90, 65);
            v8GaugeLabel8.Text = "kWh";
            v8GaugeBoughtGrid.GaugeLabels.Add(v8GaugeLabel7);
            v8GaugeBoughtGrid.GaugeLabels.Add(v8GaugeLabel8);
            ...
            v8GaugeLabel9.Color = SystemColors.Info;
            v8GaugeLabel9.Name = "GaugeLabel1";
            v8GaugeLabel9.Position = new Point(65, 50);
            v8GaugeLabel9.Text = "Consumption";
            v8GaugeLabel10.Color = SystemColors.Window;
            v8GaugeLabel10.Name = "GaugeLabel2";
            v8GaugeLabel10.Position = new Point(90, 64);
            v8GaugeLabel10.Text = "kW";
            v8GaugeHouseConsumption.GaugeLabels.Add(v8GaugeLabel9);
            v8GaugeHouseConsumption.GaugeLabels.Add(v8GaugeLabel10);
            v8GaugeRange3.Color = Color.FromArgb(192, 0, 0);
            v8GaugeRange3.EndValue = 5F;
            v8GaugeRange3.InnerRadius = 65;
            v8GaugeRange3.InRange = false;
            v8GaugeRange3.Name = "GaugeRange1";
            v8GaugeRange3.OuterRadius = 75;
            v8GaugeRange3.StartValue = 3F;
            v8GaugeHouseConsumption.GaugeRanges.Add(v8GaugeRange3);
            ...
            v8GaugeLabel11.Color = SystemColors.Info;
            v8GaugeLabel11.Name = "GaugeLabel1";
            v8GaugeLabel11.Position = new Point(58, 50);
            v8GaugeLabel11.Text = "Today Consumed";
            v8GaugeConsumed.GaugeLabels.Add(v8GaugeLabel11);
            ...
            v8GaugeLabel12.Color = SystemColors.Info;
            v8GaugeLabel12.Name = "GaugeLabel1";
            v8GaugeLabel12.Position = new Point(65, 50);
            v8GaugeLabel12.Text = "Battery Cycles";
            v8GaugeBatteryCycles.GaugeLabels.Add(v8GaugeLabel12);
            v8GaugeRange4.Color = Color.Red;
            v8GaugeRange4.EndValue = 8000F;
            v8GaugeRange4.InnerRadius = 65;
            v8GaugeRange4.InRange = false;
            v8GaugeRange4.Name = "GaugeRange1";
            v8GaugeRange4.OuterRadius = 75;
            v8GaugeRange4.StartValue = 6000F;
            v8GaugeBatteryCycles.GaugeRanges.Add(v8GaugeRange4);
            ...
            v8GaugeLabel13.Color = SystemColors.Info;
            v8GaugeLabel13.Name = "GaugeLabel1";
            v8GaugeLabel13.Position = new Point(62, 50);
            v8GaugeLabel13.Text = "Battery Charge";
            v8GaugeCharge.GaugeLabels.Add(v8GaugeLabel13);
            ...
            v8GaugeLabel14.Color = SystemColors.Info;
            v8GaugeLabel14.Name = "GaugeLabel1";
            v8GaugeLabel14.Position = new Point(72, 50);
            v8GaugeLabel14.Text = "Internal IO";
            v8GaugeLabel15.Color = Color.White;
            v8GaugeLabel15.Name = "GaugeLabel2";
            v8GaugeLabel15.Position = new Point(90, 65);
            v8GaugeLabel15.Text = "kW";
            v8GaugeLabel16.Color = Color.Lime;
            v8GaugeLabel16.Name = "GaugeLabel1";
            v8GaugeLabel16.Position = new Point(90, 130);
            v8GaugeLabel16.Text = null;
            v8GaugeInternalIO.GaugeLabels.Add(v8GaugeLabel14);
            v8GaugeInternalIO.GaugeLabels.Add(v8GaugeLabel15);
            v8GaugeInternalIO.GaugeLabels.Add(v8GaugeLabel16);
            ...
            v8GaugeLabel17.Color = SystemColors.Info;
            v8GaugeLabel17.Name = "GaugeLabel1";
            v8GaugeLabel17.Position = new Point(74, 50);
            v8GaugeLabel17.Text = "Battery %";
            v8GaugeLabel18.Color = Color.Lime;
            v8GaugeLabel18.Name = "GaugeLabel2";
            v8GaugeLabel18.Position = new Point(90, 130);
            v8GaugeLabel18.Text = "0";
            v8GaugeBattery.GaugeLabels.Add(v8GaugeLabel17);
            v8GaugeBattery.GaugeLabels.Add(v8GaugeLabel18);
            v8GaugeRange5.Color = Color.Red;
            v8GaugeRange5.EndValue = 20F;
            v8GaugeRange5.InnerRadius = 70;
            v8GaugeRange5.InRange = true;
            v8GaugeRange5.Name = "GaugeRange1";
            v8GaugeRange5.OuterRadius = 80;
            v8GaugeRange5.StartValue = 0F;
            v8GaugeRange6.Color = Color.FromArgb(0, 192, 0);
            v8GaugeRange6.EndValue = 100F;
            v8GaugeRange6.InnerRadius = 70;
            v8GaugeRange6.InRange = false;
            v8GaugeRange6.Name = "GaugeRange2";
            v8GaugeRange6.OuterRadius = 80;
            v8GaugeRange6.StartValue = 20F;
            v8GaugeBattery.GaugeRanges.Add(v8GaugeRange5);
            v8GaugeBattery.GaugeRanges.Add(v8GaugeRange6);
            ...
            v8GaugeLabel19.Color = SystemColors.Info;
            v8GaugeLabel19.Name = "GaugeLabel1";
            v8GaugeLabel19.Position = new Point(60, 50);
            v8GaugeLabel19.Text = "Generated, kWh";
            v8GaugeGeneratedSolar.GaugeLabels.Add(v8GaugeLabel19);
            ...
            v8GaugeLabel20.Color = SystemColors.Info;
            v8GaugeLabel20.Name = "GaugeLabel1";
            v8GaugeLabel20.Position = new Point(65, 50);
            v8GaugeLabel20.Text = "PV Power, kW";
            v8GaugePVPower.GaugeLabels.Add(v8GaugeLabel20);
            v8GaugeRange7.Color = Color.Red;
            v8GaugeRange7.EndValue = 90F;
            v8GaugeRange7.InnerRadius = 1;
            v8GaugeRange7.InRange = true;
            v8GaugeRange7.Name = "GaugeRange1";
            v8GaugeRange7.OuterRadius = 2;
            v8GaugeRange7.StartValue = 0F;
            v8GaugePVPower.GaugeRanges.Add(v8GaugeRange7);
            ...
            groupBox1.Size = new Size(338, 199);
            ...
            WIFICBX.Location = new Point(42, 165);
            ...
            TOUMacroCBX.Location = new Point(42, 140);
            TOUMacroCBX.Name = "TOUMacroCBX";
            TOUMacroCBX.Size = new Size(131, 19);
            ...
            TimedModeRB.Size = new Size(96, 19);
            ...
            TOUModeRB.Size = new Size(123, 19);
            ...
            TimeLBL.Location = new Point(932, 588);
            TimeLBL.Name = "TimeLBL";
            TimeLBL.Size = new Size(112, 15);
            TimeLBL.TabIndex = 43;
