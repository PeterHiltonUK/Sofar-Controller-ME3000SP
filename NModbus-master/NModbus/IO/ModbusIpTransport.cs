...
namespace NModbus.IO
{
    ...
    public class ModbusIpTransport : ModbusTransport
    {
        ...
        public override void WriteV5Frame(IModbusMessage message)
        {
           ...
           // PySolarmanV5 V5 = new PySolarmanV5("192.168.1.228", 809805460, 8899, 1, false);
          //  byte[] V5_Frame = V5._v5_frame_encoder(message.Modbus_Frame).Bytearray; // seems ok

            byte[] v5_frame = message.Modbus_Frame;
