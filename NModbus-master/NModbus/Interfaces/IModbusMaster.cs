...
namespace NModbus
{
	...
	public interface IModbusMaster : IDisposable
	{
		...
		/// </summary>
		/// 
		int V5IPPort {get;set;}
        string V5IPAddress { get; set; }
        int V5SerialNo { get; set; }


        // byte[] GetReadModbusFrame(byte slaveId, ushort startAddress, ushort numInputs);
        // byte[] GetWriteModbusFrame(byte slaveId, ushort startAddress, ushort numInputs);
        ...
        ushort[] ReadHoldingRegisters(byte slaveAddress, ushort startAddress, ushort numberOfPoints, bool V5_Frame = false);
        ushort[] ReadHoldingRegisters(string name, byte slaveAddress, ushort startAddress, ushort numberOfPoints, bool V5_Frame = false);
        ...
        /// <param name="V5_Frame"></param>
        void WriteMultipleRegisters(byte slaveAddress, ushort startAddress, ushort[] data, bool V5_Frame =false);
