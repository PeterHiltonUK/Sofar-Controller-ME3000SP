    ...
    public class StructConverter2
    {
        ...
        private static byte[] GetBytes(object o)
        {
            switch (o)
            {
                ...
                case (short s):
                    byte[] t = ByteHelper.ShortToASCICoding(s);
                    return t;
                case (ushort us):
                    byte[] t2 = ByteHelper.UShortToASCICoding(us);
                    return t2;
                case (byte b):
                    return new byte[] { b };
                case (sbyte sb):
        ...
        public static Bytes Pack(object[] items, bool LittleEndian, out string NeededFormatStringToRecover)
        {
        ...
        public static Bytes Pack(object[] items)
        {
            string dummy = "";
